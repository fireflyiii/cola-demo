...
import com.alibaba.cola.demo.infrastructure.convertor.PermissionConvertor;
...
public class PermissionGatewayImpl implements PermissionGateway {
    ...
    public void create(Permission permission) {
        PermissionEntity entity = PermissionConvertor.toEntity(permission);
    ...
    public List<Permission> listAll() {
        ...
        return entities.stream()
                .map(PermissionConvertor::toDomain)
